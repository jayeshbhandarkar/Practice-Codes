...
repeating the action 'R' number of times. If the value of 'R' is 0, print the output as '0'.
...
Explanation:
Here, the number N=99. Sum of the digits N: 9+9 = 18. Repeat step 2 'R' times i.e. 3 tims 
(9+9)+(9+9)+(9+9) = 18+18+18 =54. Add digits of 54 as we need a single digit 5+4. Hence , the output is 9.
...
Explanation:
Here, the number N=1234. Sum of the digits of N: 1+2+3+4 =10. Repeat step 2 'R' times i.e. 2 times 
(1+2+3+4)+(1+2+3+4)= 10+10=20. Add digits of 20 as we need a single digit. 2+0=2. Hence, the output is 2.
